...
addon() {
  ...
  $TOOLCHAIN/bin/python -Wi -t -B $TOOLCHAIN/lib/python$(get_pkg_variable Python PKG_INSTALL_VERSION)/compileall.py $ADDON_BUILD/$PKG_ADDON_ID/lib/ -b -f 1>/dev/null
