...
PKG_DEPENDS_TARGET="toolchain JsonSchemaBuilder:host TexturePacker:host Python3 zlib systemd pciutils lzo pcre swig:host libass curl fontconfig fribidi tinyxml libjpeg-turbo freetype libcdio taglib libxml2 libxslt rapidjson sqlite ffmpeg crossguid giflib libdvdnav libhdhomerun libfmt"
...
PKG_CMAKE_OPTS_TARGET="-DNATIVEPREFIX=$TOOLCHAIN \
                       ...
                       -DPYTHON_EXECUTABLE=$TOOLCHAIN/bin/python$(get_pkg_variable Python3 PKG_PYTHON_VERSION) \
                       -DPYTHON_INCLUDE_DIRS=$SYSROOT_PREFIX/usr/include/python$(get_pkg_variable Python3 PKG_PYTHON_VERSION) \
